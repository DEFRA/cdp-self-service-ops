...
describe('#deployService', () => {
  ...
  test('it deploys via github commit', async () => {
    const details = {
    ...
    expect(triggerDeployment).toHaveBeenCalledTimes(0)
  ...
  test('it deploys via directly to the lambda when flag is set', async () => {
    const details = {
      imageName: 'some-service',
      environment: 'dev',
      version: '0.1.0',
